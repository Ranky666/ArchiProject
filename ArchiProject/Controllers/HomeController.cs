...
namespace ArchiProject.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public ActionResult Index(List<ZipModel> files)
        {
            ...
            // кароче, это почти работает, как надо :D
            ...
            using (ZipFile zip = new ZipFile()) // Создаем объект для работы с архивом
            {
                ...
                zip.AddDirectory("D:/FilesforArchiving"); // Кладем в архив папку вместе с содежимым
                 zip.Save(@"D:/FilesforArchiving/Comprest/Zip.zip");  // Создаем архив  
            }
